...
%             to be cropped.
%   -m<val> - optional string where val indicates the factor to magnify the
...
%                        (default).
%   -<renderer> - optional string to force a particular renderer (painters,
%                 opengl or zbuffer) to be used over the default: opengl
%                 for bitmaps; painters for vector formats.
%   -<colorspace> - optional string indicating which colorspace color
%                   figures should be saved in: RGB (default), CMYK or
%                   gray. CMYK is only supported in pdf, eps and tiff
%                   output.
%   -append - optional string indicating that if the file (pdfs only)
%             already exists, the figure is to be appended as a new page,
%             instead of being overwritten (default).
